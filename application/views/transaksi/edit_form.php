                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <form action="<?php base_url('transaksi/edit') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="ti-user"></i></div>
                                        <input class="form-control <?php echo form_error('qty') ? 'is-invalid' : '' ?>" type="number" name="no_transaksi" placeholder="NO transaksi" value="<?php echo $transaksi->no_transaksi ?>">
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    <label for="qty">Keluar</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="ti-user"></i></div>
                                        <input class="form-control <?php echo form_error('qty') ? 'is-invalid' : '' ?>" type="number" name="qty" max="<?php echo $transaksi->qty ?>" placeholder="Quantity" value="">
                                    </div>
                                    <div class="invalid-feedback">
                                        <?php echo form_error('qty') ?>
                                    </div>
