                            ...
                            <form action="<?php base_url('supplier/add') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control <?php echo form_error('nama_supplier') ? 'is-invalid' : '' ?>" type="text" name="nama_supplier" placeholder="Nama Supplier" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="ti-user"></i></div>
                                        <input class="form-control <?php echo form_error('alamat') ? 'is-invalid' : '' ?>" type="text" name="alamat" placeholder="Alamat Supplier" />
                                    </div>
                                    <div class="invalid-feedback">
