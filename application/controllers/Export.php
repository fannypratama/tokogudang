...
class Export extends CI_Controller {
  ...
  public function index(){
    $data['transaksi'] = $this->Export_model->view();
  ...
  public function export(){
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('B3', "Tanggal Transaksi"); // Set kolom A3 dengan tulisan "NO"
    $excel->setActiveSheetIndex(0)->setCellValue('C3', "Nomor Transaksi"); // Set kolom B3 dengan tulisan "NIS"
    $excel->setActiveSheetIndex(0)->setCellValue('D3', "Quantity"); // Set kolom C3 dengan tulisan "NAMA"
    $excel->setActiveSheetIndex(0)->setCellValue('E3', "Nama Barang"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
    $excel->setActiveSheetIndex(0)->setCellValue('F3', "Nama Supplier");
    ...
    $transaksi = $this->Export_model->view();
    $no = 1; // Untuk penomoran tabel, di awal set dengan 1
    $numrow = 4; // Set baris pertama untuk isi tabel adalah baris ke 4
    foreach($transaksi as $data){ // Lakukan looping pada variabel siswa
      $excel->setActiveSheetIndex(0)->setCellValue('A'.$numrow, $no);
      $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $data->tanggal_transaksi);
      ...
      $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $data->kode_mbarang);
      $excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, $data->kode_supplier);
